...
import { AccordionContent, Accordion, AccordionTrigger, AccordionItem } from "@/components/ui/accordion";
  ...
  return (
    <div>
      ...
      <section className="w-full ">
        <div className="mx-auto py-4 gradient rounded-lg">
          <div className="flex flex-col items-center justify space-y-4 text-center max-w-3xl mx-auto">
            ...
            <p className="mx-auto max-w-[600px] text-primary-foreground/80 md:text-xl">
              Join thousands ot professionals who are advancing their careers with AI-powered guidance.
            </p>
            <Link href="/dashboard">
              <Button
                size="lg"
